...
**Requirements:** 
* 50 points + pass Trained Respondent Evaluation
...
* **Phase 1:** Refill coolant and generator fuel in one run of the cargo train. This must be completed in under 70 seconds.
  * You must get from the train spawn to the coolant refill with all the tracks switched.

* **Phase 2:** Turn off all core boost lasers and set the reactor power to 1 in under 35 seconds.
...
* 150 points + pass Dedicated Respondent evaluation
...
* **Phase 1:** Drain the radiation flood, engage the pumps, and clear the waste in 75 seconds.
...
* 300 points + pass Elite Respondent evaluation
